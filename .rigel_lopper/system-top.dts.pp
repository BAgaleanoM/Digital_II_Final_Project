# 0 "/home/daniel/DigFInal/Digfinal/hw/sdt/system-top.dts"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/home/daniel/DigFInal/Digfinal/hw/sdt/system-top.dts"
/dts-v1/;
# 1 "/home/daniel/DigFInal/Digfinal/hw/sdt/zynq-7000.dtsi" 1
# 10 "/home/daniel/DigFInal/Digfinal/hw/sdt/zynq-7000.dtsi"
/ {
 #address-cells = <1>;
 #size-cells = <1>;
...
# 3 "/home/daniel/DigFInal/Digfinal/hw/sdt/system-top.dts" 2
# 1 "/home/daniel/DigFInal/Digfinal/hw/sdt/pl.dtsi" 1
/ {
 amba_pl: amba_pl {
  ranges;
  compatible = "simple-bus";
  ...
  axi_bram_ctrl_0: axi_bram_ctrl_0@40000000 {
   xlnx,protocol = "AXI4";
...
# 4 "/home/daniel/DigFInal/Digfinal/hw/sdt/system-top.dts" 2
# 1 "/home/daniel/DigFInal/Digfinal/hw/sdt/pcw.dtsi" 1
 &ps7_cortexa9_0 {
...
# 5 "/home/daniel/DigFInal/Digfinal/hw/sdt/system-top.dts" 2
/ {
 board = "zybo-z7-10";
 compatible = "xlnx,zybo-z7-10";
 device_id = "7z010";
 slrcount = <1>;
 family = "Zynq";
 speed_grade = "1";
 ...
 cpus_a9: cpus-a9@0 {
  ...
  address-map = <0xf0000000 &amba 0xf0000000 0x10000000>,
         ...
         <0x41200000 &axi_gpio_0 0x41200000 0x1000>,
         <0x41210000 &axi_gpio_1 0x41210000 0x1000>,
         <0x41220000 &axi_gpio_2 0x41220000 0x10000>,
         <0x41230000 &axi_gpio_3 0x41230000 0x10000>,
         <0x41240000 &axi_gpio_4 0x41240000 0x10000>,
         <0x41250000 &axi_gpio_5 0x41250000 0x10000>,
